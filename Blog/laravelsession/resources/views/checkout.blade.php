				...
				<div class="row"> 
					<div class="col-lg-8 col-12">
						<div class="checkout-form">
							...
							<p>For now we are providing service only inside Nepal</p>
							<!-- Form -->
							@if ($errors->any())
						...
						@endif
							<form class="form" method="post" action="{{route('checkout_store')}}">
								@csrf
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											<label>Province No.<span>*</span></label>
											<select name="province" id="#">
												<option value="" selected disabled>Choose province number</option>
							...
							<div class="single-widget">
								...
								<div class="content">
									<ul>
										...
										<li>Discount<span>{{$order->discount}}(on every new item)</span></li>
