...
<html lang="en">
  <head>
    ...
    <meta name="twitter:image" content="https://www.bootstrapdash.com/az/admin/img/azia-social.png"> -->
    ...
    <meta property="og:image" content="https://www.bootstrapdash.com/az/admin/img/azia-social.png">
    <meta property="og:image:secure_url" content="https://www.bootstrapdash.com/az/admin/img/azia-social.png">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <nav class="az-menu-sub">
                <a href="{{ route('product_create') }}" class="nav-link">Create</a>
