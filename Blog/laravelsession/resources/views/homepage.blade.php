							...
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane fade show active" id="man" role="tabpanel">
									<div class="tab-single">
										<div class="row">
											@foreach ($productpass as $product)
												<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													<div class="product-img">
														<a href="/product/{{$product->id}}">
															{{-- <img class="default-img" src=" {{$product->image ==" "?"https://via.placeholder.com/550x750":asset($product->image)}}" alt="#">
															<img class="hover-img" src="{{$product->image ==" "?"https://via.placeholder.com/550x750":asset('public/images/'.$product->image)}}" alt="#"> --}}
															{{-- @if ($product->image != ' ')
										...
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.html">Hot women collection</a></h3>
														<div class="product-price">
															<span>$29.0</span>
														</div>
													</div>
